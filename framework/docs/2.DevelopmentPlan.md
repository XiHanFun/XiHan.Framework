...
- [x] **XiHan.Framework.Logging** - 统一日志记录
...
- [x] **XiHan.Framework.Web.Core** - Web 应用基础配置

  - ASP.NET Core WebHost 配置
  - Kestrel 配置、中间件管道
  - **依赖**: XiHan.Framework.Core

- [x] **XiHan.Framework.Web.Api** - RESTful API 开发

  - 控制器基类、路由管理
  - 模型绑定、API 版本控制
  - **依赖**: XiHan.Framework.Web.Core, XiHan.Framework.Serialization

- [x] **XiHan.Framework.Web.Docs** - API 文档生成
...
- [ ] **XiHan.Framework.DistributedIds** - 分布式唯一唯一标识
  - 雪花算法实现
  - ID 生成策略
  - **依赖**: XiHan.Framework.Core
