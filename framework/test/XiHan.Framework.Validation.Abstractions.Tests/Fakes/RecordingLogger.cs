...
namespace XiHan.Framework.Validation.Abstractions.Tests.Fakes;
...
/// 这里刻意让 <see cref="IsEnabled"/> 恒为 true，避免级别过滤把待断言的日志吞掉；
/// 只保留断言真正需要的「级别 + 渲染后文本」两项，不去还原 EventId 与结构化参数。
/// </remarks>
