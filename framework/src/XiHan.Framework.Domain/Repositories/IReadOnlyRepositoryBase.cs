    ...
    where TKey : IEquatable<TKey>
{
    ...
    Task<PageResultDtoBase<TEntity>> GetPagedAsync(int pageIndex, int pageSize, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">用于取消操作的标记</param>
    /// <returns>分页结果</returns>
    Task<PageResultDtoBase<TEntity>> GetPagedAsync(int pageIndex, int pageSize, Expression<Func<TEntity, bool>> predicate, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">用于取消操作的标记</param>
    /// <returns>分页结果</returns>
    Task<PageResultDtoBase<TEntity>> GetPagedAsync(int pageIndex, int pageSize, Expression<Func<TEntity, bool>>? predicate, Expression<Func<TEntity, object>> orderBy, bool isAscending = true, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">用于取消操作的标记</param>
    /// <returns>分页结果</returns>
    Task<PageResultDtoBase<TEntity>> GetPagedAsync(int pageIndex, int pageSize, ISpecification<TEntity> specification, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">用于取消操作的标记</param>
    /// <returns>分页结果</returns>
    Task<PageResultDtoBase<TEntity>> GetPagedAsync(PageRequestDtoBase query, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">用于取消操作的标记</param>
    /// <returns>分页结果</returns>
    Task<PageResultDtoBase<TEntity>> GetPagedAsync(PageRequestDtoBase query, Expression<Func<TEntity, bool>> predicate, CancellationToken cancellationToken = default);
