...
public class XiHanOllamaService : IXiHanAIService
{
    ...
    public XiHanOllamaService(
        ...
        IOptions<XiHanOllamaOptions> ollamaOptions)
    {
        _ollamaChatService = keyedServiceProvider.GetRequiredKeyedService<IChatCompletionService>(ollamaOptions.Value.ServiceId);
    }
