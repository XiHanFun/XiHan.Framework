...
//public interface IBatchCrudApplicationService<TEntityDto, TKey> : ICrudApplicationService<TEntityDto, TKey>
...
//    Task<BatchOperationResponse<TEntityDto>> BatchCreateAsync(BatchOperationRequest<TEntityDto> request);
...
//    /// <returns>批量操作响应</returns>
//    Task<BatchOperationResponse<TEntityDto>> BatchUpdateAsync(BatchUpdateRequest<TKey, TEntityDto> request);
...
//public interface IBatchCrudApplicationService<TEntityDto, TKey, TCreateDto, TUpdateDto> : IBatchCrudApplicationService<TEntityDto, TKey>, ICrudApplicationService<TEntityDto, TKey, TCreateDto, TUpdateDto>
//    where TEntityDto : class
//    where TKey : IEquatable<TKey>
