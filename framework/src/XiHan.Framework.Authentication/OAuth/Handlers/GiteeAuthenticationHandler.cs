...
/// </summary>
/// <remarks>
/// 只在用户信息接口没给出邮箱时补取一次邮箱，其余沿用基类。
/// </remarks>
public class GiteeAuthenticationHandler : XiHanOAuthHandler<GiteeAuthenticationOptions>
{
    private const string EmailScope = "emails";
    ...
    protected override async Task AfterClaimActionsAsync(ClaimsIdentity identity, OAuthTokenResponse tokens, JsonElement payload)
    {
        ...
        var email = emails.RootElement.EnumerateArray()
            .Select(address => ReadString(address, "email"))
