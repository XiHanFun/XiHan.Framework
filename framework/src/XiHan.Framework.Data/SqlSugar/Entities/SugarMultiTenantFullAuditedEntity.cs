...
public abstract class SugarMultiTenantFullAuditedEntity<TKey> : SugarFullAuditedEntity<TKey>, IMultiTenantEntity
    where TKey : IEquatable<TKey>
{
    /// <summary>
    /// 构造函数
    /// </summary>
    protected SugarMultiTenantFullAuditedEntity() : base()
    {
    }
    ...
    protected SugarMultiTenantFullAuditedEntity(TKey basicId) : base(basicId)
    {
    }
    ...
    protected SugarMultiTenantFullAuditedEntity(TKey basicId, TKey createdId) : base(basicId, createdId)
    {
    }
